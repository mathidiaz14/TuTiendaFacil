	                ...
	                <div class="card-body">
        						<div class="row">
        							<div class="col-12 col-md-10 offset-md-1">
        								<form action="{{url('root/ayuda/entrada')}}" class="form horizontal" method="post">
                          @csrf
                          ...
                          <div class="form-group">
                            <textarea name="contenido" id="editor" rows="10" class="summernote form-control" required=""></textarea>
                          </div>
