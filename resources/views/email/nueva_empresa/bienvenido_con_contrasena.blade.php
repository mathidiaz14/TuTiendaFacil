									...
									<tr>
										<td class="hero-subheader__content" style=" line-height: 27px; color: #969696; padding: 0 0px 50px 0;" align="left">
											...
											<p>Hola, <b>{{$contenido['nombre']}}</b>:
												<br><br>
												Nos encanta darte la bienvenida a nuestra plataforma, puedes ingresar accediendo a <a href="{{url('login')}}" target="_blank">tutiendafacil.uy/login</a> con el email <b>{{$contenido['email']}}</b> y la contraseña <b>{{$contenido['contrasena']}}</b>.
												<br><br>
