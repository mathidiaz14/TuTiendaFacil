...
<head>
  ...
  <title>TuTiendaFacil.uy - Tu tienda online en minutos</title>
  ...
  <!-- Custom CSS -->
  <link href="{{asset('landing/css/stylish-portfolio.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <header class="masthead d-flex" >
    <div class="container text-center my-auto text-white">
      <h1 class="mb-1" style="text-shadow:1px 1px 2px #000000; font-size: 3em;">
      	Lamentablemente ocurrio un error inesperado, si el error persiste comuniquese con el administrador de la web. 
      </h1>
      <br><br>
      <h3 class="mb-5" style="text-shadow:1px 1px 2px #000000;">
        <em><a href="{{url('/')}}">Ir al inicio</a></em>
      </h3>
    </div>
