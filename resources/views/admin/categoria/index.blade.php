@extends('layouts.dashboard', ['menu_activo' => 'categoria'])
									...
									<div class="table table-responsive">
										<table class="table table-striped">
											...
											@foreach($categorias as $categoria)
												<tr>
													<td><img src="{{categoria_url_imagen($categoria->id)}}" alt="" width="50px"></td>
													<td>
														<a href="http://{{$categoria->empresa->URL}}/categoria/{{$categoria->url}}" target="_blank">{{$categoria->url}}</a>
													</td>
													<td>{{$categoria->titulo}}</td>
													<td>{{$categoria->observacion == null ? "--" : $categoria->observacion}}</td>
													<td class="text-center">
														<a href="{{url('admin/categoria', $categoria->id)}}" class="btn btn-success">
															<i class="fa fa-eye"></i>
														</a>
													</td>
													<td class="text-center">
														      		...
														      		<div class="modal-body">
														    			<form action="{{url('admin/categoria', $categoria->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
														    				...
														    				@if($categoria->imagen != null)
															    				<div class="form-group">
															    					<img src="{{asset($categoria->imagen)}}" alt="" width="100px">
															    					<br><br>
