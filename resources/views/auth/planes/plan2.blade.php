...
@section('contenido')
    <form action="{{url('registrar/plan2')}}" method="post" class="login100-form validate-form" style="padding-top: 100px;">
        @csrf
...
@section('scripts')
  <script>
    $(document).ready(function(tecla)
    {
      ...
      {
        $.get("{{url('registrar/comprobar/plan2')}}/"+$('#url').val()+$('#extension option:selected').text(), function(respuesta)
        {
          if(respuesta == "si")
          {
